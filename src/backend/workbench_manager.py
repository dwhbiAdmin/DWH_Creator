...
class WorkbenchManager:
    ...
    def _generate_artifact_comments(self) -> bool:
        ...
        try:
            ...
            if updated:
                return self.excel_utils.write_sheet_data(self.workbook_path, "Artifacts", artifacts_df)
    ...
    def _generate_column_comments(self) -> bool:
        ...
        try:
            ...
            if updated:
                return self.excel_utils.write_sheet_data(self.workbook_path, "Columns", columns_df)
